package com.nickand.moviesfeed.search.adapters;
...
public class SearchListAdapter extends RecyclerView.Adapter<SearchListAdapter.ListItemViewHolder> {

    private List<ViewModel> list;
    private List<ViewModel> url;

    public SearchListAdapter(List<ViewModel> list) {
        this.list = list;
    }
